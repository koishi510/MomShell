...
export const WISP_DATA: WispData[] = [
  ...
  /* Through-sun wisps */
  {
    ...
    h: 12,
    color:
      "linear-gradient(to right, transparent 0%, rgba(210, 120, 110, 0.80) 35%, rgba(195, 100, 95, 0.95) 50%, rgba(210, 120, 110, 0.80) 65%, transparent 100%)",
    blur: 5,
    behind: true,
  },
  {
    ...
    h: 8,
    color:
      "linear-gradient(to right, transparent 0%, rgba(215, 128, 118, 0.65) 30%, rgba(205, 110, 105, 0.82) 50%, rgba(215, 128, 118, 0.65) 70%, transparent 100%)",
    blur: 4,
    behind: true,
  },
];
...
export const GLOW_BLOCKS: GlowBlockData[] = [
  ...
  { top: 30, h: 26, w: 300, alpha: 0.3, blur: 22, dur: 5.5 },
  { top: 48, h: 22, w: 250, alpha: 0.22, blur: 20, dur: 8 },
  { top: 62, h: 18, w: 180, alpha: 0.15, blur: 18, dur: 6.5 },
];

export const REFLECTION_WIDTH_CURVE = [
  9, 8, 7, 6, 5, 3, 3, 5, 4, 7, 2, 4, 4, 6, 3, 3, 3, 5, 4, 2, 2, 3, 3, 5, 6, 6,
  7, 7, 8,
];
