 ...
 */
function computeOffsetForSprite(spriteId: string): number | null {
  const sprite = SPRITES.find(s => s.id === spriteId)
  if (!sprite) return null
  const leftPercent = parseFloat(sprite.left)
  if (isNaN(leftPercent)) return null
  const vw = window.innerWidth
  // Also account for sprite width to center on the middle of the sprite
  const spriteWidthVw = parseFloat(sprite.width) || 0
  ...
  const steps = [
    {
      ...
      popover: {
        ...
        description: '这块坚稳的石头是你倾诉心声的安全树洞。无论何时，点这里都可以开启一段充满共情的对话。',
        side: 'top',
        align: 'center',
      },
    },
    {
      ...
      popover: {
        ...
        description: '去木屋看看大家在讨论什么吧！这里连接着广大的妈妈群体和资深认证的专家医疗人员。',
        side: 'top',
        align: 'start',
      },
    },
    {
      ...
      popover: {
        ...
        description: '每一个贝壳都藏着一个关于你的专属回忆。提供几个标签，AI 就会为你生成充满怀旧感的个人绘本。',
        side: 'top',
        align: 'center',
      },
    },
    {
      ...
      popover: {
        ...
        description: '小车承载着生活的点滴。当你伴侣登录时，这里是你们情感互助交流的重要窗口。',
        side: 'top',
        align: 'end',
      },
    },
    {
      ...
      popover: {
        title: 'Tasks (恢复目标)',
        description: '点亮这颗海星，给自己设定一些小目标吧！比如做五分钟冥想或者散步，每天一点点进步。',
        side: 'top',
        align: 'center',
      },
    },
    {
      ...
      popover: {
        title: 'Whisper (海螺低语)',
        description: '不想打字时，就对着海螺诉说吧。它会倾听并将你的声音化为文字记录下来。',
        side: 'top',
        align: 'center',
      },
    },
    {
      ...
      popover: {
        title: '小螃蟹 (随时向导)',
        description: '迷路了或者想探索隐藏功能？随时点这只小螃蟹，它会给你各种有趣的提示。',
        side: 'right',
        align: 'center',
      },
    },
