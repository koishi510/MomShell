<template>
  <div class="dc-home dc-tab-content-full">
    <div class="dc-home-inner">
      <!-- Welcome Header -->
      <div class="dc-home-header">
      ...
      <div class="dc-grid">
        <!-- Status Widget -->
        <div class="dc-widget dc-widget-status">
        ...
        <!-- Daily Tip Widget -->
        <div class="dc-widget dc-widget-tip">
          <div class="dc-widget-header">
      ...
      <!-- Quick Actions Grid -->
      <h3 class="dc-section-title">快捷指令</h3>
      <div class="dc-action-grid">
        <button class="dc-action-card" @click="$emit('navigate', 'tasks')">
        ...
        <button class="dc-action-card" @click="$emit('navigate', 'dashboard')">
          <div class="dc-action-icon">
        ...
        <button class="dc-action-card" @click="$emit('navigate', 'chat')">
          <div class="dc-action-icon">
        ...
        <button class="dc-action-card" @click="$emit('navigate', 'community')">
          <div class="dc-action-icon">
          ...
          <div class="dc-action-text">
            ...
            <span class="dc-action-desc">./network.sh</span>
          </div>
        </button>

        <button class="dc-action-card" @click="$emit('navigate', 'whisper')">
          <div class="dc-action-icon">
          ...
          <div class="dc-action-text">
            ...
            <span class="dc-action-desc">./journal.sh</span>
          </div>
        </button>

        <button class="dc-action-card" @click="$emit('navigate', 'profile')">
          <div class="dc-action-icon">
          ...
          <div class="dc-action-text">
            ...
            <span class="dc-action-desc">./config.sh</span>
          </div>
        </button>
      </div>
    </div>
